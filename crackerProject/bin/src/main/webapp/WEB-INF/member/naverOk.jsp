...
<div id="loginform">   
   <div id="login">
      <p class="intro" align="center">${naverNickName }님 로그인</p>
      <p class="intro" align="center">${naverEmail }</p>
      <button type="button" class="btn btn-primary btn-lg btn-block" style="width: 100%;
    	border: 1px #000000 solid; background: #000000;" onclick="openPopUp()">로그아웃</button>
      <div class="info">
      	<dl class="infotext">
      		<dd id=infologin><img src="/index/image/home/person.svg"/ style="margin-bottom: 5px;"><a href="#" id = "naverBtn">회원정보수정</a></dd>
